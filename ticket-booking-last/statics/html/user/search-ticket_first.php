	...
	<div class="wrapper">
		...
		<main class="container">
			...
			<section class="search">
				<form action="result-ticket_first.php" method="post" class="form-data">
					...
					<div class="input-box">
						<div class="form-input input-third">
					...
					<div class="form__btns">
						...
						<div class="default-font form__choose">
							<a href="#" class="no-bor-outl-deco">Một chiều</a>
							<a href="search-ticket_khuhoi_first.php" class="no-bor-outl-deco">
								Khứ hồi
							</a>
						</div>
						<!-- END: switch page -->
