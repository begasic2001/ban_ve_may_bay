					...
					if(isset($_POST['Search']))
					{
						...
						if(empty($data_missing)) {
							...
							if($class=="economy") {
								...
								mysqli_stmt_bind_param($stmt, "sssis", $origin, $destination, $dep_date, $no_of_pass, $ngay_ve);
								...
								if(mysqli_stmt_num_rows($stmt)==0) {
									...
									echo "<form action=\"passenger-info_khuhoi_second.php\" method=\"post\" class=\"text-center\">";
								...
								mysqli_stmt_store_result($stmt);
								if(mysqli_stmt_num_rows($stmt)==0) {
									echo "<h3>Không Tìm Thấy Chuyến Bay !</h3>";
								} else {
									echo "<form action=\"passenger-info_khuhoi_second.php\" method=\"post\" class=\"text-center\">";
									echo "<table class=\"res-table\">";
									echo 
