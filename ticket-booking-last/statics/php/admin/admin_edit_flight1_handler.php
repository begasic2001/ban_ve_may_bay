    ...
    <?php
        ...
        if (isset($_POST["capnhat"])) {
            ...
            if (! empty($ma_chuyen_bay) && ! empty($noi_di) && ! empty($noi_den) &&
                ! empty($ngay_bat_dau) && ! empty($ngay_ket_thuc) && ! empty($gio_bat_dau) &&
                ! empty($gio_ket_thuc) && ! empty($so_luong_economy) && ! empty($so_luong_business)&& ! empty($gia_economy) && ! empty($gia_business) && ! empty($ma_may_bay)&&
                ! empty($ngay_ve) ) {
                $sql = 
                    "UPDATE chuyen_bay 
                    SET from_city='$noi_di', to_city='$noi_den' , ngay_bat_dau='$ngay_bat_dau' , ngay_ket_thuc='$ngay_ket_thuc', gio_bat_dau ='$gio_bat_dau',gio_ket_thuc='$gio_ket_thuc', so_luong_economy='$so_luong_economy' , so_luong_business='$so_luong_business', gia_economy ='$gia_economy', gia_business='$gia_business', ma_may_bay='$ma_may_bay',ngay_ve='$ngay_ve'
    ...
    <div class="container">        
        ...
        <form action="" method="post" enctype="multipart/form-data" name="">
            <table class="default-font table-edit">
                ...
                <tr>
                    <th>Ngày Về: </th>
                    <td><input type="text" name="ngay_ve" value="<?php echo $ngay_ve; ?>"></td>
                </tr>
                <tr>
                    <td colspan="2">
